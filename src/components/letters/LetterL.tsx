export function LetterL() {
    return (<>
            ...
            <circle stroke="#ffc67e" stroke-width="2" fill="none" cx="396" cy="590" r="65.99999999988381"
                    style={{position: "absolute"}}/>
            <circle stroke="#ffc67e" stroke-width="2" fill="none" cx="438" cy="545" r="1"
                    style={{position: "absolute"}}/>
            <circle stroke="#ffc67e" stroke-width="2" fill="none" cx="450" cy="559" r="1"
                    style={{position: "absolute"}}/>
            <circle stroke="#ffc67e" stroke-width="2" fill="none" cx="423" cy="534" r="1"
                    style={{position: "absolute"}}/>
